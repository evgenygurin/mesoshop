...
class Subscription extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'     => $page,
			'limit'    => $limit,
			'callback' => fn (int $page): string => $this->url->link('account/subscription', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token'] . ($page ? '&page=' . $page : ''))
		]);
	...
	protected function getHistory(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'     => $page,
			'limit'    => $limit,
			'callback' => fn (int $page): string => $this->url->link('account/subscription.history', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token'] . '&subscription_id=' . $subscription_id . ($page ? '&page=' . $page : ''))
		]);
	...
	protected function getOrders(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'     => $page,
			'limit'    => $limit,
			'callback' => fn (int $page): string => $this->url->link('account/subscription.order', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token'] . '&subscription_id=' . $subscription_id . ($page ? '&page=' . $page : ''))
		]);
