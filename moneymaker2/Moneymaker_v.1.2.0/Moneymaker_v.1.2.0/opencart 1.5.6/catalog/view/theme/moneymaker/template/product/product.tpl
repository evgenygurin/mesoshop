    ...
    <div class="col-sm-12">
      ...
      <div class="row row-product pos-10">
        ...
        <div class="<?php if ($mmr_cols == 0) { echo 'col-sm-8'; } else {echo 'col-sm-7';}  ?>" id="product-controls">
          ...
          <?php if ($profiles) { ?>
          <div class="panel panel-default">
            <div class="panel-body profiles">
              <div class="form-group required">
                <label class="control-label" for="input-profile"><?php echo $text_payment_profile ?></label>
                <select name="profile_id" class="form-control" id="input-profile">
                  <option value=""><?php echo $text_select; ?></option>
