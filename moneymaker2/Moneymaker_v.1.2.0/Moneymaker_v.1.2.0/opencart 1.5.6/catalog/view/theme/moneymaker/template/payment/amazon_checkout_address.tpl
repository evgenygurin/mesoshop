        ...
        <div class="col-sm-12 pos-9">
          ...
          <div class="row pagination_buttons">
            <div class="col-xs-12 text-center">
              <p class="pull-left"><a href="<?php echo $cart; ?>" class="btn btn-lg btn-default"><i class="fa fa-chevron-circle-left"></i> <?php echo $text_cart; ?></a></p>
              <p class="pull-right"><a id="continue-button" class="btn btn-lg btn-primary"><i class="fa fa-chevron-circle-right"></i> <?php echo $text_continue; ?></a></p>
            </div>
          </div>
