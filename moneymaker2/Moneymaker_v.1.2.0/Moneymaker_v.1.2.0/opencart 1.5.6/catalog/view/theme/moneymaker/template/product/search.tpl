...
<div id="content">
  <div class="row">
    <div class="col-sm-12">
      ...
      <?php if ($this->config->get('mmr_advantages_enabled')&&$this->config->get('mmr_advantages')&&$this->config->get('mmr_advantages_display_search')) { ?>
            ...
            <div class="col-sm-7">
              <div class="input-group form-group">
                ...
                <span class="input-group-btn">
                  <button id="button-search" class="btn btn-primary"><?php echo $button_search; ?></button>
                </span>
              </div>
            </div>
            <div class="col-sm-5">
