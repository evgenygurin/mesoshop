...
<div id="content">
  <div class="row">
    <div class="col-sm-12">
      ...
      <?php if ($this->config->get('mmr_advantages_enabled')&&$this->config->get('mmr_advantages')&&$this->config->get('mmr_advantages_display_manufacturer')) { ?>
        ...
        <div class="col-sm-12 pos-9">
          ...
          <div class="row pagination_buttons">
            <div class="col-xs-12 text-center">
              <a class="btn btn-lg btn-primary" href="<?php echo $continue; ?>"><?php echo $button_continue; ?></a>
            </div>
          </div>
          <?php } ?>
        </div>
