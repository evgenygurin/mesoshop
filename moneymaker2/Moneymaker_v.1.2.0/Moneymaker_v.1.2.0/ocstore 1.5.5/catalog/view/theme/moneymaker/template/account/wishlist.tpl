        ...
        <div class="col-sm-12 pos-9">
                  ...
                  <div class="price-buttons">
                    <div class="buy-buttons">
                      <div class="btn-group">
                        ...
                        <?php if (!$this->config->get('mmr_common_btn_wishlist_hidden')) { ?><a href="<?php echo $product['remove']; ?>" class="btn btn-default" data-toggle="tooltip" title="<?php echo $button_remove; ?>"><i class="fa fa-times"></i></a><?php } ?>
          ...
          <div class="row pagination_buttons">
            <div class="col-xs-12 text-center pagination">
              <p><a href="<?php echo $continue; ?>" class="btn btn-lg btn-default"><i class="fa fa-chevron-circle-right"></i> <?php echo $button_continue; ?></a></p>
            </div>
          </div>
          <?php } else { ?>
          <div class="row">
