<?php
if (isset($_POST['page_url'])) {$page_url = trim($_POST['page_url']);}
if (isset($_POST['mmr_callback_fields'])) {$product_fields = $_POST['mmr_callback_fields'];}
if (isset($_POST['mmr_callback_fields_label'])) {$product_fields_label = $_POST['mmr_callback_fields_label'];}
if (isset($_POST['mmr_callback_fields_required'])) {$product_fields_required = $_POST['mmr_callback_fields_required'];}
...
if ($valid) {
  ...
  $text = $email_order_received  . $newline . $newline .
    $email_order_detail . $newline . $email_url.": ".$page_url . $newline . $newline;
  foreach ($product_fields as $key => $product_field) {
