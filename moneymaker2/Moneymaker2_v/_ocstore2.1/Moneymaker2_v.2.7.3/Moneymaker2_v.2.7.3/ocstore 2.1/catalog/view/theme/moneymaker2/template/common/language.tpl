...
<li class="dropdown" id="language-dropdown">
  ...
  <ul class="dropdown-menu keep-open">
    ...
    <li <?php if ($language['code'] == $code) { ?>class="active"<?php } ?>><a href="javascript:void(0);" class="language-select" onclick="$('input[name=\'code\']').val('<?php echo $language['code']; ?>'); $('#language').submit();"><span><img src="image/flags/<?php echo $language['image']; ?>" alt="<?php echo $language['name']; ?>" title="<?php echo $language['name']; ?>"></span>&nbsp; <?php echo $language['name']; ?></a></li>
    <?php } ?>
  </ul>
</li>
<?php } else { ?>
<li>
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="language">
    <ul class="dropdown-menu">
      ...
      <?php foreach ($languages as $language) { ?>
      <li <?php if ($language['code'] == $code) { ?>class="active"<?php } ?>><a href="javascript:void(0);" onclick="$('input[name=\'code\']').attr('value', '<?php echo $language['code']; ?>'); $('#language').submit();"><span><img src="image/flags/<?php echo $language['image']; ?>" alt="<?php echo $language['name']; ?>" /></span>&nbsp; <?php echo $language['name']; ?></a></li>
      <?php } ?>
    </ul>
  </form>
</li>
