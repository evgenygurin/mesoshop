...
<?php if ($moneymaker2_common_minify) { ?>
  ...
  <?php } ?>
  <link href="min/?g=moneymaker2_css<?php echo $moneymaker2_minify['int_css'] ? "&f=".implode(',', $moneymaker2_minify['int_css']) : ''; ?>&v=<?php echo $moneymaker2_date; ?>" rel="stylesheet">
  ...
  <?php } ?>
  <script src="min/?g=moneymaker2_js<?php echo $moneymaker2_minify['int_js'] ? "&f=".implode(',', $moneymaker2_minify['int_js']) : ''; ?>&v=273"></script>
<?php } else { ?>
