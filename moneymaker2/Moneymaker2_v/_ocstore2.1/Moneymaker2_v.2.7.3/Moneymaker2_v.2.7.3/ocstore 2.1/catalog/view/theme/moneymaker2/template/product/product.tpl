  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>" itemscope itemtype="https://schema.org/Product">
      ...
      <div class="h2 text-center content-title">
        <h1 class="h2" itemprop="name"><?php echo $heading_title; ?><?php if ($moneymaker2_code) { ?> <small>(<?php echo $moneymaker2_code; ?>)</small><?php } ?></h1>
            ...
            <div class="col-sm-12 col-md-6">
              ...
              <div id="product" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                ...
                <div class="btn-group">
                  ...
                  <?php } ?>
                  <input type="number" data-toggle="tooltip" data-placement="bottom" min="1" name="quantity" value="<?php echo $minimum; ?>" id="input-quantity" class="form-control<?php if ($moneymaker2_common_buy_hide) { ?> hidden<?php } ?>" title="<?php echo $entry_qty; ?>" />
        ...
        <div class="product-layout product-grid">
          <div class="product-thumb">
            ...
            <div>
              ...
              <?php if ($moneymaker2_common_price_detached) { ?>
              <div class="price-detached"><small><?php if ($product['price']) { ?><span class="price text-muted"><?php if (!$product['special']) { ?><?php echo $product['price']; ?><?php } else { ?><span class="price-new"><b><?php echo $product['special']; ?></b></span> <span class="price-old"><?php echo $product['price']; ?></span><?php } ?></span><?php if ($product['tax']) { ?><br /><span class="price-tax text-muted"><?php echo $text_tax; ?> <?php echo $product['tax']; ?></span><?php } ?><?php } ?></small></div>
              <?php } ?>
