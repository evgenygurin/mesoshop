      ...
      <div class="modal-body">
        ...
        <div class="form-horizontal">
          ...
          <?php if ($moneymaker2_common_recaptcha) { ?>
            <?php echo $moneymaker2_common_recaptcha; ?>
          <?php } ?>
          <?php if ($text_agree) { ?>
          <div class="form-group">
...
<?php if ($moneymaker2_modules_callback_enabled&&$moneymaker2_modules_callback_float_enabled) { ?>
<div class="btn btn-primary btn-floating-callback" data-toggle="modal" data-target="#orderModal" data-order-mode="callback" data-order-title="<?php echo $moneymaker2_modules_callback_header; ?>" <?php if ($moneymaker2_modules_callback_image) { ?>data-order-img-src="<?php echo $moneymaker2_modules_callback_image; ?>"<?php } ?>><div data-toggle="tooltip" data-template='<div class="tooltip btn-floating-callback-tooltip hidden-xs" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>' data-placement="top" title="<?php echo $moneymaker2_modules_callback_header; ?>"><i class="fa fa-2x fa-phone"></i></div></div>
<?php } ?>
