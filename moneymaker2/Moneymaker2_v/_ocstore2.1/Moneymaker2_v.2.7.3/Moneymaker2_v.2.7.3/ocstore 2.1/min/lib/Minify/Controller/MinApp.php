        ...
        if ($sources) {
            if (null !== $firstMissingResource) {
                array_unshift($sources, new Minify_Source(array(
                    ...
                    ,'content' => strpos($this->_type, 'javascript') ? "console.log('Minify: at least one missing file: ".$firstMissingResource."'); /* Minify: at least one missing file. See " . Minify::URL_DEBUG . " */\n" : "/* Minify: at least one missing file. See " . Minify::URL_DEBUG . " */\n"
                    ,'minifier' => ''
                )));
            }
