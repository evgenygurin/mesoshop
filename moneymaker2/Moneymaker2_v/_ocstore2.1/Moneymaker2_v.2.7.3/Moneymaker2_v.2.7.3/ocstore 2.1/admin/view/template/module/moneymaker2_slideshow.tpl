...
$moneymaker2_banners_bg_styles = array('dark','light','transparent');
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select name="background_style" class="form-control">
								<?php foreach ($moneymaker2_banners_bg_styles as $moneymaker2_banners_bg_style) { ?>
								<?php ($moneymaker2_banners_bg_style == $background_style) ? $active = 'selected' : $active=''; ?>
								<option value="<?php echo $moneymaker2_banners_bg_style; ?>" <?php echo $active; ?>><?php echo $moneymaker2_banners_bg_style; ?></option>
								<?php } ?>
							</select>
						</div>
					</div>
