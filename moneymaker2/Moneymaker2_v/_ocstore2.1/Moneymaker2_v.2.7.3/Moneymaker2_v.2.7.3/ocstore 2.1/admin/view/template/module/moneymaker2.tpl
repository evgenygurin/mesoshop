...
if(empty($moneymaker2_header_strip_font_color)) $moneymaker2_header_strip_font_color = array();
...
if(empty($moneymaker2_header_strip_sl_font_color)) $moneymaker2_header_strip_sl_font_color = array();
...
if(empty($moneymaker2_header_categorystrip_font_color)) $moneymaker2_header_categorystrip_font_color = array();
...
if(empty($moneymaker2_header_categorystrip_sl_font_color)) $moneymaker2_header_categorystrip_sl_font_color = array();
...
if(empty($moneymaker2_header_logo_custom_color1)) $moneymaker2_header_logo_custom_color1 = array();
...
if(empty($moneymaker2_header_logo_custom_color2)) $moneymaker2_header_logo_custom_color2 = array();
...
if(empty($moneymaker2_header_logo_custom_header_color)) $moneymaker2_header_logo_custom_header_color = array();
...
if(empty($moneymaker2_header_logo_custom_caption_color)) $moneymaker2_header_logo_custom_caption_color = array();
...
if(empty($moneymaker2_catalog_products_stock_color)) $moneymaker2_catalog_products_stock_color = array();
...
if(empty($moneymaker2_product_thumbs_height)) $moneymaker2_product_thumbs_height                                        = $config_image_additional_height + 10;
...
if(empty($moneymaker2_product_points_stock_color)) $moneymaker2_product_points_stock_color = array();
...
if(empty($moneymaker2_footer_links_font_color)) $moneymaker2_footer_links_font_color = array();
...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right hidden">
				...
				<button type="submit" form="form-moneymaker2" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary hidden"><i class="fa fa-save"></i></button>
	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-moneymaker2" class="form-horizontal">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="tab_common">
								<fieldset>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $entry_common_recaptcha_help; ?>"><?php echo $entry_common_recaptcha; ?></span></label>
										<div class="col-sm-4">
											<select name="moneymaker2_common_recaptcha" class="form-control">
												<?php if ($moneymaker2_common_recaptcha) { ?>
												<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
												<option value="0"><?php echo $text_disabled; ?></option>
												<?php } else { ?>
												<option value="1"><?php echo $text_enabled; ?></option>
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php $filename = '../catalog/view/theme/moneymaker2/stylesheet/stylesheet.custom.css';
											...
											$moneymaker2_styles.= ".navbar-header > a, #top.navbar-default .btn-link.dropdown-toggle {color: ".$moneymaker2_header_strip_font_color[0].";}";
											$moneymaker2_styles.= ".navbar-header > a:hover, .navbar-header > a:focus, #top.navbar-default .btn-link.dropdown-toggle:focus, #top.navbar-default .btn-link.dropdown-toggle:hover {color: ".$moneymaker2_header_strip_font_color[1].";}";
											$moneymaker2_styles.= ".owl-moneymaker2-fullscreen .navbar-header > a, .owl-moneymaker2-fullscreen #top.navbar-default .btn-link.dropdown-toggle {color: ".$moneymaker2_header_strip_sl_font_color[0].";}";
											$moneymaker2_styles.= ".owl-moneymaker2-fullscreen .navbar-header > a:hover, .owl-moneymaker2-fullscreen .navbar-header > a:focus, .owl-moneymaker2-fullscreen #top.navbar-default .btn-link.dropdown-toggle:hover, .owl-moneymaker2-fullscreen #top.navbar-default .btn-link.dropdown-toggle:focus {color: ".$moneymaker2_header_strip_sl_font_color[1].";}";
											...
											$moneymaker2_styles.= ".moneymaker_activity > div {background: linear-gradient(to bottom, rgba(".$moneymaker2_common_themes_bg_color_rgb[0].",".$moneymaker2_common_themes_bg_color_rgb[1].",".$moneymaker2_common_themes_bg_color_rgb[2].", 0.0), rgb(".$moneymaker2_common_themes_bg_color_rgb[0].",".$moneymaker2_common_themes_bg_color_rgb[1].",".$moneymaker2_common_themes_bg_color_rgb[2]."), rgb(".$moneymaker2_common_themes_bg_color_rgb[0].",".$moneymaker2_common_themes_bg_color_rgb[1].",".$moneymaker2_common_themes_bg_color_rgb[2]."));}";
											...
											if (isset($moneymaker2_product_thumbs_height)&&$moneymaker2_product_thumbs_height>0) {
												if ($moneymaker2_product_gallery_moved) {
													$moneymaker2_styles.= ".col-sm-12 .thumbnails.image-additional{height:".($moneymaker2_product_thumbs_height+16)."px}@media (max-width: 767px){.col-sm-12 .thumbnails.image-additional{height:".($moneymaker2_product_thumbs_height+25)."px}}";
												} else {
													$moneymaker2_styles.= ".col-sm-12 .thumbnails.image-additional{height:".$moneymaker2_product_thumbs_height."px}";
												}
											}
											...
											$moneymaker2_styles.= "@media screen and (max-width: 767px) {body, html {overflow-x: hidden;} body > .container > .row {position: relative;} #column-left {left: -72%;margin-left: 15px;} #column-right {right: -72%;margin-right: 15px;} #column-left, #column-right {position: absolute;top: 0;width: 68%;}#column-left.active, #column-right.active {width: 72%;} }";
											}
											...
											$moneymaker2_styles.= "#content.col-sm-12 .catalog-advantage {width: ".((1132-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "#content.col-sm-9 .catalog-advantage {width: ".((840-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "#content.col-sm-6 .catalog-advantage {width: ".((548-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "}";
											$moneymaker2_styles.= "@media (min-width: 992px) and (max-width: 1199px) { ";
											$moneymaker2_styles.= "#content.col-sm-12 .catalog-advantage {width: ".((932-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "#content.col-sm-9 .catalog-advantage {width: ".((662-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "#content.col-sm-6 .catalog-advantage {width: ".((448-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "}";
											$moneymaker2_styles.= "@media (min-width: 768px) and (max-width: 991px) { ";
											$moneymaker2_styles.= "#content.col-sm-12 .catalog-advantage {width: ".((712-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "#content.col-sm-9 .catalog-advantage {width: ".((502-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "#content.col-sm-6 .catalog-advantage {width: ".((338-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "}";
											$moneymaker2_styles.= "@media (min-width: 561px) and (max-width: 767px) { ";
											$moneymaker2_styles.= "#content .catalog-advantage {width: ".((506-$moneymaker2_image_category_width)/2)."px;}";
											$moneymaker2_styles.= "}";
								...
								<fieldset>
									...
									<div class="form-group">
										...
										$moneymaker2_filename_writing = '../catalog/view/theme/moneymaker2/stylesheet/bootstrap-theme-colors.css';
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label"><?php echo $entry_block_height; ?></label>
									<div class="col-sm-3">
										<div class="input-group">
											<input type="number" min="1" name="moneymaker2_product_thumbs_height" value="<?php echo $moneymaker2_product_thumbs_height; ?>" class="form-control">
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="tab-modules_callback">
												<fieldset>
													...
													<div class="form-group">
														<label class="col-sm-3 control-label"><?php echo $entry_floating_button; ?></label>
														<div class="col-sm-6">
															<label class="radio-inline"><input type="radio" name="moneymaker2_modules_callback_float_enabled" value="1" <?php if ($moneymaker2_modules_callback_float_enabled) { ?>checked="checked"<?php } ?> /> <?php echo $text_yes; ?></label>
															<label class="radio-inline"><input type="radio" name="moneymaker2_modules_callback_float_enabled" value="0" <?php if (!$moneymaker2_modules_callback_float_enabled) { ?>checked="checked"<?php } ?> /> <?php echo $text_no; ?></label>
														</div>
													</div>
													<div class="form-group">
	...
	function apply() {
		$.ajax({
			url: 'index.php?route=module/moneymaker2/getMaxInputVars&token=<?php echo $token; ?>',
			cache: false,
			type: 'post',
			dataType: 'json',
			beforeSend: function() {
			...
			complete: function() {
				...
				var moneymaker2_inputs = $('#form-moneymaker2 :input:not([class*="btn"])').length - $('#form-moneymaker2 input[type=radio]').length/2 - $('#moneymaker2_categories input[type=hidden]').length - $('#moneymaker2_informations input[type=hidden]').length;
				var moneymaker2_max_input_vars = $('#modal_max_input_vars').text();
				if (moneymaker2_inputs<=moneymaker2_max_input_vars-1) {
					$('#form-moneymaker2').append('<input type="hidden" id="apply" name="apply" value="1"  />');
					resetCategoriesIcons();
					resetInformationsIcons();
					$('#form-moneymaker2').submit();
				} else {
