        ...
        <div class="<?php echo $class; ?>">
          <div class="product-thumb transition">
            ...
            <div class="btn-group btn-group-sm">
              <button type="button" class="btn" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span> <i class="fa fa-shopping-cart"></i></button>
